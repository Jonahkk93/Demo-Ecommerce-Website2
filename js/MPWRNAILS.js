...
let icon2Cart = document.querySelector('.icon2-cart');
let icon2CartSpan = document.querySelector('.icon2-cart span');
...
const addCartToHTML = () => {
    ...
    if(carts.length > 0){
        carts.forEach(cart => {
            ...
            newCart.dataset.id = cart.product_id; //minus or pluss
